...
const AboutCard = () => {
  return (
    <div className='flex flex-col items-center justify-center gap-8 pb-2  lg:pb-5 lg:flex-row'>
      <img src={img} alt="about_image" className='lg:w-[30rem] lg:h-[30rem] object-cover p-3 sm:w-[80vw] rounded-md' />
